  ...
  \cventry
    ...
    {Mar. 2022 - Nov. 2025}
    {
      \begin{cvitems}
        ...
        \item {Environnement : eXtreme Programming, DDD, CQRS, event sourcing, systèmes distribués, Kotlin, Arrow, Typescript, Node.js, React, GraphQL, PostgreSQL, Firestore, GCP, Kubernetes.}
      \end{cvitems}
    }
