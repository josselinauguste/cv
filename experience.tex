  ...
  \cventry
    ...
    {Depuis 2014}
    {
      \begin{cvsubentries}
        ...
        \cvsubentry{}{Fable Conf : la conférence européenne annuelle dédiée au langage F\# et au compilateur Javascript Fable}{2017}{}
        \cvsubentry{}{Agile Tour Bordeaux : événement annuel dédié à l’agilité réunissant 300 personnes sur 2 jours}{2016, 2017}{}
        \cvsubentry{}{Bdx I/O : réunie chaque année 500 développeurs pour discuter des technologies de développement}{2014, 2015, 2016}{}
      \end{cvsubentries}
    }
  ...
  \cventry
    ...
    {Depuis oct. 2012}
    {
      \begin{cvitems}
        ...
        \item {Environnement technique : Ruby et Ruby on Rails, React et React Native, PHP, Scala, CoffeeScript, technologies web, Ansible, Docker.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Août 2010 - Sept. 2012}
    {
      \begin{cvitems}
        ...
        \item {Environnement technique : Microsoft .Net 4, ASP.NET MVC 3, Silverlight 4, Windows Communication Foundation, Microsoft SQL Server 2008, Transact-SQL.}
      \end{cvitems}
    }
